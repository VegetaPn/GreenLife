...
public class LoginServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = null;
		if (code != null) {
			url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx8882f63ed713f1af&secret=d4624c36b6795d1d99dcf0547af5443d&code="
		...
		String refreshUrl = "https://api.weixin.qq.com/sns/oauth2/refresh_token?appid=wx8882f63ed713f1af&grant_type=refresh_token&refresh_token="
				+ refresh_token;
